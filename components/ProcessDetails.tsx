...
const ProcessDetails: React.FC<ProcessDetailsProps> = ({ processLog, aiError }) => {
  ...
  return (
    <div className="mt-4 bg-white dark:bg-dl-dark-surface rounded-xl shadow-card border border-dl-border dark:border-dl-dark-border p-6 animate-fade-in-up transition-colors">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded border border-gray-100 dark:border-gray-700 font-sans text-dl-text dark:text-gray-200 max-h-32 overflow-y-auto scrollbar-thin whitespace-pre-wrap break-words">
          ...
          <div>
            ...
            <div className={`text-sm p-2 rounded border font-mono text-xs break-all max-h-32 overflow-y-auto scrollbar-thin ${aiError ? 'bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-900/30 text-red-600 dark:text-red-300' : 'bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-900/30 text-dl-primary dark:text-blue-300'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded border border-gray-100 dark:border-gray-700 font-jp text-dl-text dark:text-gray-200 max-h-32 overflow-y-auto scrollbar-thin whitespace-pre-wrap break-words">
          ...
          <div>
            ...
            <div className="text-sm bg-teal-50 dark:bg-teal-900/20 p-2 rounded border border-teal-100 dark:border-teal-900/30 font-mono text-teal-800 dark:text-teal-300 text-xs break-all max-h-32 overflow-y-auto scrollbar-thin">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="text-sm bg-purple-50 dark:bg-purple-900/20 p-2 rounded border border-purple-100 dark:border-purple-900/30 font-mono text-purple-800 dark:text-purple-300 text-xs break-all max-h-32 overflow-y-auto scrollbar-thin">
          ...
          <div>
            ...
            <div className="text-sm bg-indigo-50 dark:bg-indigo-900/20 p-2 rounded border border-indigo-100 dark:border-indigo-900/30 font-jp text-indigo-800 dark:text-indigo-300 text-xs break-all max-h-32 overflow-y-auto scrollbar-thin">

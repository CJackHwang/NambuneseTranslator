...
const OutputPanel: React.FC<OutputPanelProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-dl-output dark:bg-dl-dark-surface relative h-full min-h-[300px] max-h-[60vh] md:max-h-full md:min-h-auto border-t md:border-t-0 md:border-l border-dl-border dark:border-dl-dark-border transition-colors">
      ...
      {/* Bottom Controls */}
      <div className={`border-t border-dl-border dark:border-dl-dark-border bg-dl-output dark:bg-dl-dark-surface px-4 py-3 md:py-0 md:h-14 flex flex-col gap-3 md:flex-row md:items-center md:justify-between shrink-0 transition-all`}>
